...
public class FogDevice extends PowerDatacenter {
    ...
    public double getNextEnergyConsumption() {
    	
    	double timeNow = CloudSim.clock();
        double nextEnergyConsumption = (timeNow - lastUtilizationUpdateTime) * getHost().getPowerModel().getPower(lastUtilization);
        //lastUtilization = Math.min(1, totalMipsAllocated / getHost().getTotalMips());
        //lastUtilizationUpdateTime = timeNow;
        
        return nextEnergyConsumption;
    }
    
    public double getLuut() {
    ...
    protected void sendDownFreeLink(Tuple tuple, int childId) {
        ...
        //System.out.println(getChildToLatencyMap());
